...
from chemutils.version import __version__ as _version

# -- Project information -----------------------------------------------------

project = 'Chemutils'
copyright = (f'{datetime.now().year}, MFM Group')
author = 'MFM Group'
...
intersphinx_mapping = {
    ...
    'chemtrain': ('https://mfm.pages.gitlab.lrz.de/science/chemtrain/main/', None)
}
